...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/dataleon',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the dataleon MCP server. You will use Code Mode to help the user perform
