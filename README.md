...
[![NPM version](<https://img.shields.io/npm/v/dataleon.svg?label=npm%20(stable)>)](https://npmjs.org/package/dataleon) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/dataleon)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/dataleon-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install dataleon`
...
```ts
import Dataleon from 'npm:dataleon';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/dataleon-typescript/issues) with questions, bugs, or suggestions.
